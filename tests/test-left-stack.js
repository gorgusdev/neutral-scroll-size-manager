...
manager.addLeftStacker('ROOT', document.getElementById('second-container'), secondStack, '#second-limit', 0, '#second-container', false, false, function(stacked, offset, useFixed, hidden, lastStacked) {
    if(stacked) {
